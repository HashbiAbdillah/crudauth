          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                ...
                <input name="name" type="text" class="form-control @error('name') {{ 'is-invalid' }} @enderror" id="nama"  placeholder="Nama Pemeran" value="{{ @old('nama') }}">
                </div>
                @error('name')
              ...
              <div class="form-group">
                ...
                <input name="umur" type="number" class="form-control @error('umur') {{ 'is-invalid' }} @enderror" id="nama"  placeholder="Umur Pemeran" value="{{ @old('umur')}}">
              </div>
              @error('umur')
                <span id="terms-error" class="error invalid-feedback" style="display: inline;">{{ $message }}</span>
              @enderror
...
<!-- jquery-validation -->
<script src="{{ asset('atmint/plugins/jquery-validation/jquery.validate.min.js') }}"></script>
<script src="{{ asset('atmint/plugins/jquery-validation/additional-methods.min.js') }}"></script>
<!-- AdminLTE App -->
